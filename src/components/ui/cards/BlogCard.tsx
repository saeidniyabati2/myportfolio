...
export const BlogCard: React.FC<props> = ({
  ...
  return (
    <div className="w-full  flex flex-col rounded-md overflow-hidden group cursor-pointer hover:shadow-2xl transition-all duration-500 ">
      {/* container of image */}
      ...
      <div className="p-5 bg-grayMain group-hover:bg-white ">
        ...
        <h5 className="mt-1 group-hover:text-mainButton transition-all duration-500">
          {title}
        </h5>
