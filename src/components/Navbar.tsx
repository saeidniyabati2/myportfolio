...
export const Navbar: React.FC = () => {
  return (
    <nav className="w-full  flex bg-red-500 px-4">
      <div className="w-full h-full  lg:basis-[73%] flex bg-grayMain pt-4 lg:pl-[15rem]">
        {/* container of image */}
        {/* just desktop */}
        <div className=" h-full  relative  items-center basis-4/12 hidden lg:flex">
          <Image
            width={100}
            height={100}
            alt=""
        ...
        {/* just mobile */}
        <div className=" h-full relative flex items-center lg:hidden ">
          <Image
            width={200}
            height={200}
            alt=""
        ...
        {/* just for desktop */}
        <div className="w-full  items-center basis-8/12 hidden lg:flex">
        ...
        {/* just for mobile */}
        <div className="w-full bg-fuchsia-700 flex items-center justify-end  lg:hidden">
          <div className="w-10 h-10 bg-mainButton rounded-md relative ">
            <Image fill alt="" src="/assets/menu-svgrepo-com.svg" />
          </div>
        </div>
      </div>
      <div className="w-full  basis-[27%]  items-center gap-x-3 bg-[#ECF6FF] pl-10 hidden lg:flex">
        {/* container of icon */}
